# Dargslan.WinNuGetAudit — 2026 Edition

> **NuGet and .NET package audit toolkit — installed packages, outdated detection, vulnerability scanning, and dependency analysis**

[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinNuGetAudit-blue)](https://www.powershellgallery.com/packages/Dargslan.WinNuGetAudit)
...
```powershell
Install-Module -Name Dargslan.WinNuGetAudit -Scope CurrentUser
```

## Quick Start

```powershell
Import-Module Dargslan.WinNuGetAudit
Get-NuGetAudit
Get-NuGetAudit -Json
```
