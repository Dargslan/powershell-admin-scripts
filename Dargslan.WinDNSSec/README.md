# Dargslan.WinDNSSec — 2026 Edition

> **Windows DNS security audit toolkit — DNSSEC validation, DNS-over-HTTPS, DNS cache poisoning defense, and resolver hardening**

[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinDNSSec-blue)](https://www.powershellgallery.com/packages/Dargslan.WinDNSSec)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinDNSSec -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinDNSSec
Get-DNSSecurityAudit
Get-DNSSecurityAudit -Json
\`\`\`
