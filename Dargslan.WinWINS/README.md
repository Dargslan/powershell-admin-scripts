...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinWINS-blue)](https://www.powershellgallery.com/packages/Dargslan.WinWINS)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinWINS -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinWINS
Get-WINSAudit
Get-WINSAudit -Json
\`\`\`
