# Dargslan.WinBrowserSec — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinBrowserSec-blue)](https://www.powershellgallery.com/packages/Dargslan.WinBrowserSec)
...
```powershell
Install-Module -Name Dargslan.WinBrowserSec -Scope CurrentUser
```

## Quick Start

```powershell
Import-Module Dargslan.WinBrowserSec
Get-BrowserSecurityAudit
Get-BrowserSecurityAudit -Json
```
