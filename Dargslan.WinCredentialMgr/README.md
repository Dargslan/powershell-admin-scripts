# Dargslan.WinCredentialMgr — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinCredentialMgr-blue)](https://www.powershellgallery.com/packages/Dargslan.WinCredentialMgr)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinCredentialMgr -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinCredentialMgr
Get-CredentialManagerAudit
Get-CredentialManagerAudit -Json
\`\`\`
