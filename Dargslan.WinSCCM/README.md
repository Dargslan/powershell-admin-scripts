...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinSCCM-blue)](https://www.powershellgallery.com/packages/Dargslan.WinSCCM)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinSCCM -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinSCCM
Get-SCCMAudit
Get-SCCMAudit -Json
\`\`\`
