# Dargslan.WinPrintNightmare — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinPrintNightmare-blue)](https://www.powershellgallery.com/packages/Dargslan.WinPrintNightmare)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![2026 Edition](https://img.shields.io/badge/Edition-2026-green.svg)](https://dargslan.com)

Part of the [Dargslan Windows Admin Toolkit](https://dargslan.com) — 120 professional PowerShell modules.

## Installation

\`\`\`powershell
Install-Module -Name Dargslan.WinPrintNightmare -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinPrintNightmare
Get-PrintSpoolerSecurity
Get-PrintSpoolerSecurity -Json
\`\`\`
