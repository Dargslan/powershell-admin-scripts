# Dargslan.WinPowerPlan — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinPowerPlan-blue)](https://www.powershellgallery.com/packages/Dargslan.WinPowerPlan)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinPowerPlan -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinPowerPlan
Get-PowerPlanAudit
Get-PowerPlanAudit -Json
\`\`\`
