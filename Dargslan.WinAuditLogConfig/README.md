# Dargslan.WinAuditLogConfig — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinAuditLogConfig-blue)](https://www.powershellgallery.com/packages/Dargslan.WinAuditLogConfig)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinAuditLogConfig -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinAuditLogConfig
Get-AuditLogConfig
Get-AuditLogConfig -Json
\`\`\`
