...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinDedup-blue)](https://www.powershellgallery.com/packages/Dargslan.WinDedup)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinDedup -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinDedup
Get-DedupAudit
Get-DedupAudit -Json
\`\`\`
