# Dargslan.WinRansomGuard — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinRansomGuard-blue)](https://www.powershellgallery.com/packages/Dargslan.WinRansomGuard)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinRansomGuard -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinRansomGuard
Get-RansomwareProtection
Get-RansomwareProtection -Json
\`\`\`
