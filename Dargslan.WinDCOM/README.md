# Dargslan.WinDCOM — 2026 Edition

> **DCOM configuration audit toolkit — DCOM applications, launch permissions, access security, and attack surface assessment**

[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinDCOM-blue)](https://www.powershellgallery.com/packages/Dargslan.WinDCOM)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinDCOM -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinDCOM
Get-DCOMAudit
Get-DCOMAudit -Json
\`\`\`
