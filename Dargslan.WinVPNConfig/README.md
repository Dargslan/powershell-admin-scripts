# Dargslan.WinVPNConfig — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinVPNConfig-blue)](https://www.powershellgallery.com/packages/Dargslan.WinVPNConfig)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinVPNConfig -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinVPNConfig
Get-VPNAudit
Get-VPNAudit -Json
\`\`\`
