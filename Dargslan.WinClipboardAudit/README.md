# Dargslan.WinClipboardAudit — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinClipboardAudit-blue)](https://www.powershellgallery.com/packages/Dargslan.WinClipboardAudit)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinClipboardAudit -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinClipboardAudit
Get-ClipboardAudit
Get-ClipboardAudit -Json
\`\`\`
