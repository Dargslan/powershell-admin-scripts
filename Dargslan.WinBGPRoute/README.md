# Dargslan.WinBGPRoute

> **Windows routing and BGP audit toolkit — routing table, persistent routes, RRAS status, BGP peers, and network interfaces**

[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinBGPRoute-blue)](https://www.powershellgallery.com/packages/Dargslan.WinBGPRoute)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinBGPRoute -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinBGPRoute
Get-BGPRouteAudit
