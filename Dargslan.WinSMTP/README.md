...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinSMTP-blue)](https://www.powershellgallery.com/packages/Dargslan.WinSMTP)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinSMTP -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinSMTP
Get-SMTPAudit
Get-SMTPAudit -Json
\`\`\`
