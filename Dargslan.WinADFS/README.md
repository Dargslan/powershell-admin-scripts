...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinADFS-blue)](https://www.powershellgallery.com/packages/Dargslan.WinADFS)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinADFS -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinADFS
Get-ADFSAudit
Get-ADFSAudit -Json
\`\`\`
