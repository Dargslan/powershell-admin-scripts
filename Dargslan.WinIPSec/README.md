# Dargslan.WinIPSec — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinIPSec-blue)](https://www.powershellgallery.com/packages/Dargslan.WinIPSec)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinIPSec -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinIPSec
Get-IPSecAudit
Get-IPSecAudit -Json
\`\`\`
