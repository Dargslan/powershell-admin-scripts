# Dargslan.WinIISCryptoAudit — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinIISCryptoAudit-blue)](https://www.powershellgallery.com/packages/Dargslan.WinIISCryptoAudit)
...
```powershell
Install-Module -Name Dargslan.WinIISCryptoAudit -Scope CurrentUser
```

## Quick Start

```powershell
Import-Module Dargslan.WinIISCryptoAudit
Get-IISCryptoAudit
Get-IISCryptoAudit -Json
```
