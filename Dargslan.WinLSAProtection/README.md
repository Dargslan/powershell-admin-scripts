# Dargslan.WinLSAProtection — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinLSAProtection-blue)](https://www.powershellgallery.com/packages/Dargslan.WinLSAProtection)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinLSAProtection -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinLSAProtection
Get-LSAProtectionStatus
Get-LSAProtectionStatus -Json
\`\`\`
