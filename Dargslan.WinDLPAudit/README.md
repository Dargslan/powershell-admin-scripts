# Dargslan.WinDLPAudit — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinDLPAudit-blue)](https://www.powershellgallery.com/packages/Dargslan.WinDLPAudit)
...
```powershell
Install-Module -Name Dargslan.WinDLPAudit -Scope CurrentUser
```

## Quick Start

```powershell
Import-Module Dargslan.WinDLPAudit
Get-DLPAudit
Get-DLPAudit -Json
```
