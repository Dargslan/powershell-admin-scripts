# Dargslan.WinCOMHijack — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinCOMHijack-blue)](https://www.powershellgallery.com/packages/Dargslan.WinCOMHijack)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinCOMHijack -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinCOMHijack
Get-COMHijackAudit
Get-COMHijackAudit -Json
\`\`\`
