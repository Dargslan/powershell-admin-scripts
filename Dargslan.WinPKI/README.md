...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinPKI-blue)](https://www.powershellgallery.com/packages/Dargslan.WinPKI)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinPKI -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinPKI
Get-PKIAudit
Get-PKIAudit -Json
\`\`\`
