# Dargslan.WinPythonAudit — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinPythonAudit-blue)](https://www.powershellgallery.com/packages/Dargslan.WinPythonAudit)
...
```powershell
Install-Module -Name Dargslan.WinPythonAudit -Scope CurrentUser
```

## Quick Start

```powershell
Import-Module Dargslan.WinPythonAudit
Get-PythonAudit
Get-PythonAudit -Json
```
