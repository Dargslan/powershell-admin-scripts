# Dargslan.WinRemoteAccess

> **Windows Remote Access VPN audit toolkit — RRAS configuration, VPN protocols, SSTP, IKEv2, RADIUS, and connection stats**

[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinRemoteAccess-blue)](https://www.powershellgallery.com/packages/Dargslan.WinRemoteAccess)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinRemoteAccess -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinRemoteAccess
