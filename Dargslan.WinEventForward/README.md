# Dargslan.WinEventForward — 2026 Edition

> **Windows Event Forwarding (WEF) audit toolkit — subscriptions, collector status, source computers, event delivery optimization**

[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinEventForward-blue)](https://www.powershellgallery.com/packages/Dargslan.WinEventForward)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![2026 Edition](https://img.shields.io/badge/Edition-2026-green.svg)](https://dargslan.com)

Part of the [Dargslan Windows Admin Toolkit](https://dargslan.com) — 100 professional PowerShell modules.

## Installation

```powershell
Install-Module -Name Dargslan.WinEventForward -Scope CurrentUser
```

## Quick Start

```powershell
Import-Module Dargslan.WinEventForward
Get-EventForwardingAudit
Get-EventForwardingAudit -Json
```
