# Dargslan.WinNPSAudit

> **Windows Network Policy Server audit toolkit — RADIUS policies, connection request policies, NAS clients, and accounting**

[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinNPSAudit-blue)](https://www.powershellgallery.com/packages/Dargslan.WinNPSAudit)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinNPSAudit -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinNPSAudit
Get-NPSAudit
Get-NPSAudit -Json
\`\`\`
