# Dargslan.WinASRRules — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinASRRules-blue)](https://www.powershellgallery.com/packages/Dargslan.WinASRRules)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinASRRules -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinASRRules
Get-ASRRulesAudit
Get-ASRRulesAudit -Json
\`\`\`
