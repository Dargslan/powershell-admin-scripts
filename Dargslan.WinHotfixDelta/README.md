# Dargslan.WinHotfixDelta — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinHotfixDelta-blue)](https://www.powershellgallery.com/packages/Dargslan.WinHotfixDelta)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinHotfixDelta -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinHotfixDelta
Get-HotfixDeltaAnalysis
Get-HotfixDeltaAnalysis -Json
\`\`\`
