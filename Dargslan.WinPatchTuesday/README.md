# Dargslan.WinPatchTuesday — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinPatchTuesday-blue)](https://www.powershellgallery.com/packages/Dargslan.WinPatchTuesday)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinPatchTuesday -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinPatchTuesday
Get-PatchTuesdayAudit
Get-PatchTuesdayAudit -Json
\`\`\`
