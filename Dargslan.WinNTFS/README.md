...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinNTFS-blue)](https://www.powershellgallery.com/packages/Dargslan.WinNTFS)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinNTFS -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinNTFS
Get-NTFSAudit
Get-NTFSAudit -Json
\`\`\`
