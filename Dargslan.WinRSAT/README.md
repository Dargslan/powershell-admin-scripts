...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinRSAT-blue)](https://www.powershellgallery.com/packages/Dargslan.WinRSAT)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinRSAT -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinRSAT
Get-RSATAudit
Get-RSATAudit -Json
\`\`\`
