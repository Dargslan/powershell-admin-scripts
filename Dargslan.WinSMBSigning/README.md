# Dargslan.WinSMBSigning — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinSMBSigning-blue)](https://www.powershellgallery.com/packages/Dargslan.WinSMBSigning)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinSMBSigning -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinSMBSigning
Get-SMBSigningAudit
Get-SMBSigningAudit -Json
\`\`\`
