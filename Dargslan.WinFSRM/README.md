...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinFSRM-blue)](https://www.powershellgallery.com/packages/Dargslan.WinFSRM)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinFSRM -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinFSRM
Get-FSRMAudit
Get-FSRMAudit -Json
\`\`\`
