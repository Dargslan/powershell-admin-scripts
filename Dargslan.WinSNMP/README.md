...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinSNMP-blue)](https://www.powershellgallery.com/packages/Dargslan.WinSNMP)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinSNMP -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinSNMP
Get-SNMPAudit
Get-SNMPAudit -Json
\`\`\`
