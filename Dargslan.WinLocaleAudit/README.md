# Dargslan.WinLocaleAudit — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinLocaleAudit-blue)](https://www.powershellgallery.com/packages/Dargslan.WinLocaleAudit)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinLocaleAudit -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinLocaleAudit
Get-LocaleAudit
Get-LocaleAudit -Json
\`\`\`
