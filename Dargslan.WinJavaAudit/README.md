# Dargslan.WinJavaAudit — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinJavaAudit-blue)](https://www.powershellgallery.com/packages/Dargslan.WinJavaAudit)
...
```powershell
Install-Module -Name Dargslan.WinJavaAudit -Scope CurrentUser
```

## Quick Start

```powershell
Import-Module Dargslan.WinJavaAudit
Get-JavaAudit
Get-JavaAudit -Json
```
