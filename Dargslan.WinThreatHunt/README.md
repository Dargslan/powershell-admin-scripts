# Dargslan.WinThreatHunt — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinThreatHunt-blue)](https://www.powershellgallery.com/packages/Dargslan.WinThreatHunt)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinThreatHunt -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinThreatHunt
Get-ThreatHuntScan
Get-ThreatHuntScan -Json
\`\`\`
