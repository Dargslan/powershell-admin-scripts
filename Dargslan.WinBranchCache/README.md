# Dargslan.WinBranchCache

> **Windows BranchCache audit toolkit — cache status, hosted mode, distributed mode, content servers, bandwidth savings**

[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinBranchCache-blue)](https://www.powershellgallery.com/packages/Dargslan.WinBranchCache)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinBranchCache -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinBranchCache
