# Dargslan.WinBluetooth — 2026 Edition

> **Windows Bluetooth device audit toolkit — paired devices, drivers, service status, security settings, and Bluetooth policy**

[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinBluetooth-blue)](https://www.powershellgallery.com/packages/Dargslan.WinBluetooth)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinBluetooth -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinBluetooth
Get-BluetoothAudit
Get-BluetoothAudit -Json
\`\`\`
