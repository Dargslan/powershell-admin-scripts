# Dargslan.WinSharedFolders — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinSharedFolders-blue)](https://www.powershellgallery.com/packages/Dargslan.WinSharedFolders)
...
```powershell
Install-Module -Name Dargslan.WinSharedFolders -Scope CurrentUser
```

## Quick Start

```powershell
Import-Module Dargslan.WinSharedFolders
Get-SharedFolderAudit
Get-SharedFolderAudit -Json
```
