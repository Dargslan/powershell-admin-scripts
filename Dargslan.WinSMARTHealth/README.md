# Dargslan.WinSMARTHealth — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinSMARTHealth-blue)](https://www.powershellgallery.com/packages/Dargslan.WinSMARTHealth)
...
```powershell
Install-Module -Name Dargslan.WinSMARTHealth -Scope CurrentUser
```

## Quick Start

```powershell
Import-Module Dargslan.WinSMARTHealth
Get-SMARTHealth
Get-SMARTHealth -Json
```
