...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinWDS-blue)](https://www.powershellgallery.com/packages/Dargslan.WinWDS)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinWDS -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinWDS
Get-WDSAudit
Get-WDSAudit -Json
\`\`\`
