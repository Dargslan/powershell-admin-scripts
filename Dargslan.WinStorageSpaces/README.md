# Dargslan.WinStorageSpaces

> **Windows Storage Spaces audit toolkit — pools, virtual disks, physical disks, tiers, resiliency, and health monitoring**

[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinStorageSpaces-blue)](https://www.powershellgallery.com/packages/Dargslan.WinStorageSpaces)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![2026 Edition](https://img.shields.io/badge/Edition-2026-green.svg)](https://dargslan.com)

Part of the [Dargslan Windows Admin Toolkit](https://dargslan.com) — 140 professional PowerShell modules.

## Installation

\`\`\`powershell
Install-Module -Name Dargslan.WinStorageSpaces -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinStorageSpaces
