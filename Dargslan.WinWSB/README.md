# Dargslan.WinWSB — 2026 Edition

> **Windows Server Backup audit toolkit — backup schedule, backup history, backup destinations, and recovery catalog status**

[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinWSB-blue)](https://www.powershellgallery.com/packages/Dargslan.WinWSB)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinWSB -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinWSB
Get-WSBAudit
Get-WSBAudit -Json
\`\`\`
