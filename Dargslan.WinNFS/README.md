...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinNFS-blue)](https://www.powershellgallery.com/packages/Dargslan.WinNFS)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinNFS -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinNFS
Get-NFSAudit
Get-NFSAudit -Json
\`\`\`
