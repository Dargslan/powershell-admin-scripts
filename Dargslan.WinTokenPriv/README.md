# Dargslan.WinTokenPriv — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinTokenPriv-blue)](https://www.powershellgallery.com/packages/Dargslan.WinTokenPriv)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinTokenPriv -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinTokenPriv
Get-TokenPrivilegeAudit
Get-TokenPrivilegeAudit -Json
\`\`\`
