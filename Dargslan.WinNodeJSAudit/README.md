# Dargslan.WinNodeJSAudit — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinNodeJSAudit-blue)](https://www.powershellgallery.com/packages/Dargslan.WinNodeJSAudit)
...
```powershell
Install-Module -Name Dargslan.WinNodeJSAudit -Scope CurrentUser
```

## Quick Start

```powershell
Import-Module Dargslan.WinNodeJSAudit
Get-NodeJSAudit
Get-NodeJSAudit -Json
```
