# Dargslan.WinRemediation — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinRemediation-blue)](https://www.powershellgallery.com/packages/Dargslan.WinRemediation)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinRemediation -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinRemediation
Get-RemediationStatus
Get-RemediationStatus -Json
\`\`\`
