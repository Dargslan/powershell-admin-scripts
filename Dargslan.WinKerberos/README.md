# Dargslan.WinKerberos — 2026 Edition

> **Kerberos authentication audit toolkit — ticket cache, SPN inventory, delegation analysis, and Kerberos policy validation**

[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinKerberos-blue)](https://www.powershellgallery.com/packages/Dargslan.WinKerberos)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinKerberos -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinKerberos
Get-KerberosAudit
Get-KerberosAudit -Json
\`\`\`
