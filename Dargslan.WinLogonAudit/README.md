# Dargslan.WinLogonAudit — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinLogonAudit-blue)](https://www.powershellgallery.com/packages/Dargslan.WinLogonAudit)
...
```powershell
Install-Module -Name Dargslan.WinLogonAudit -Scope CurrentUser
```

## Quick Start

```powershell
Import-Module Dargslan.WinLogonAudit
Get-LogonAudit
Get-LogonAudit -Json
```
