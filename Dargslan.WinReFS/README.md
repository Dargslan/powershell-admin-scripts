...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinReFS-blue)](https://www.powershellgallery.com/packages/Dargslan.WinReFS)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinReFS -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinReFS
Get-ReFSAudit
Get-ReFSAudit -Json
\`\`\`
