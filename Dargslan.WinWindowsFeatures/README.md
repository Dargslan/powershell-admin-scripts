# Dargslan.WinWindowsFeatures — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinWindowsFeatures-blue)](https://www.powershellgallery.com/packages/Dargslan.WinWindowsFeatures)
...
```powershell
Install-Module -Name Dargslan.WinWindowsFeatures -Scope CurrentUser
```

## Quick Start

```powershell
Import-Module Dargslan.WinWindowsFeatures
Get-WindowsFeaturesAudit
Get-WindowsFeaturesAudit -Json
```
