# Dargslan.WinMemoryForensic — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinMemoryForensic-blue)](https://www.powershellgallery.com/packages/Dargslan.WinMemoryForensic)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinMemoryForensic -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinMemoryForensic
Get-MemoryForensicScan
Get-MemoryForensicScan -Json
\`\`\`
