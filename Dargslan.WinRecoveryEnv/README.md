# Dargslan.WinRecoveryEnv — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinRecoveryEnv-blue)](https://www.powershellgallery.com/packages/Dargslan.WinRecoveryEnv)
...
```powershell
Install-Module -Name Dargslan.WinRecoveryEnv -Scope CurrentUser
```

## Quick Start

```powershell
Import-Module Dargslan.WinRecoveryEnv
Get-RecoveryAudit
Get-RecoveryAudit -Json
```
