# Dargslan.WinNetworkShare — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinNetworkShare-blue)](https://www.powershellgallery.com/packages/Dargslan.WinNetworkShare)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinNetworkShare -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinNetworkShare
Get-NetworkShareSecurity
Get-NetworkShareSecurity -Json
\`\`\`
