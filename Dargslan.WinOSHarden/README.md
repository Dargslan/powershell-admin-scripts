# Dargslan.WinOSHarden — 2026 Edition
...
[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinOSHarden-blue)](https://www.powershellgallery.com/packages/Dargslan.WinOSHarden)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinOSHarden -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinOSHarden
Get-HardeningAssessment
Get-HardeningAssessment -Json
\`\`\`
