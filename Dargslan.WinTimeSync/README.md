# Dargslan.WinTimeSync

> **Windows time synchronization audit toolkit — NTP configuration, W32Time service, stratum, time drift, and sync peers**

[![PowerShell Gallery](https://img.shields.io/badge/PowerShell%20Gallery-Dargslan.WinTimeSync-blue)](https://www.powershellgallery.com/packages/Dargslan.WinTimeSync)
...
\`\`\`powershell
Install-Module -Name Dargslan.WinTimeSync -Scope CurrentUser
\`\`\`

## Quick Start

\`\`\`powershell
Import-Module Dargslan.WinTimeSync
Get-TimeSyncAudit
